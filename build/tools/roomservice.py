...
DEBUG = False
default_manifest = ".repo/manifests/discovery_default.xml"
custom_local_manifest = ".repo/local_manifests/discovery_manifest.xml"
custom_default_revision = "8.0"
custom_dependencies = "discovery.dependencies"
org_manifest = "DiscoveryTeam"  # leave empty if org is provided in manifest
org_display = "DiscoveryTeam"  # needed for displaying
